 # The future isn't homebrewed apps, it's markdown + vanilla web tech + Claude. 
...
- **HTML Kanban board** for visualization and drag-and-drop interaction/editing
...
## 12 points that changed my everyday life
...
11. Also, no need to find ways to connect different notes or files. Instead of 'knowledge management', backlinks and tags, I just talk to Claude Cowork.
12. And, to paraphrase Dani Rojas, I realized that markdown is life! It's the language of agents and if you use it as the foundation for your digital life, you can turn it into anything. A great tip is the Zed editor: It has git integration, folder tree view, collaboration and model agnostic agent panels all in one view. It is the 'IDE for anything'.
