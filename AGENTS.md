...
.Codex/skills/books-notes/books-notes-export.sh list           # Apple Books highlights
.Codex/skills/books-notes/books-notes-export.sh export <id>
```
...
**`templates/ReadMe.md` does not describe this repo.** It documents a separate Codex
...
partway. See `.Codex/skills/books-notes/SKILL.md` for the extraction rules — notably
